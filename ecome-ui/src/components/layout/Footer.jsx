export default function Footer() {
    return (
        <footer className="border-t bg-gray-50 dark:bg-gray-800 dark:border-gray-700 transition-colors duration-300 mt-10">
            <div className="max-w-7xl mx-auto px-4 py-10 grid grid-cols-1 md:grid-cols-4 gap-8">
                <div>
                    <h3 className="font-semibold mb-3 text-gray-900 dark:text-gray-200">
                        Categories
                    </h3>
